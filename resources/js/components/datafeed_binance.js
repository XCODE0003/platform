...
export const getBars = async (
    ...
    try {
        ...
        const url = new URL(
            window.location.origin + BINANCE_REST_PROXY + '/klines',
        );
...
export const subscribeBars = (
    ...
    ws.onmessage = (evt) => {
        ...
        tradeStore.setPrice(bar.close);
        tradeStore.setVolume(bar.volume);
        tradeStore.setHigh(bar.high);
        tradeStore.setLow(bar.low);
        tradeStore.setVolumeChange(bar.volume - tradeStore.volume);
